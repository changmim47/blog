...
[블로그 컨셉]
- 일상에서 새로 알게 된 도구·서비스·정보·트렌드를 직접 써보고 정리하는 1인 블로거 (직장인 시점)
- 다루는 분야: AI 도구는 물론, 투자·금융·생산성 도구·구독 서비스·일상 정보 등 직접 경험한 것 무엇이든
- 한국어 콘텐츠, 친근하고 솔직한 1인칭 후기 톤
- 독자: 같은 주제를 검색하다가 글을 발견한 한국 사용자

[중요 — title/angle 어디서도 절대 금지]
- "비전공자도", "초보자도", "전문가가 아니어도", "주린이도" 같은 독자 자격 한정 표현
- "AI 비전공자가", "직장인을 위한", "~분들을 위해" 같은 자기소개·대상 한정 표현
- 영상이 투자 주제면 투자 글, 도구 주제면 도구 글로 그대로 풀 것. AI 컨셉에 우겨 넣지 말 것.
